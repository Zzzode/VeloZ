---
name: "kj-library"
description: "Use when working with KJ types (kj::Own, kj::Maybe, kj::Promise, etc.), async I/O, or when migrating from std to KJ patterns."
---
...
- `libs/core/kj/` - KJ library source code (headers)
- `docs/kjdoc/tour.md` - KJ tour and concepts
- `docs/kjdoc/style-guide.md` - KJ coding style guide
