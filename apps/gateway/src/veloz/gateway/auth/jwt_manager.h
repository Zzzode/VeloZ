...
private:
   ...
   */
  [[nodiscard]] kj::Array<byte> base64url_decode(kj::StringPtr encoded);
   ...
   */
  [[nodiscard]] kj::String base64url_encode(kj::ArrayPtr<const byte> data);
   ...
   */
  [[nodiscard]] kj::Array<byte> hmac_sha256(const unsigned char* key, size_t key_len,
   ...
   */
  [[nodiscard]] bool verify_hmac_sha256(kj::StringPtr key, kj::ArrayPtr<const byte> data,
                                        kj::ArrayPtr<const byte> signature);
