...
struct ApiKey {
  ...
  ApiKey& operator=(ApiKey&&) = delete; // Not move-assignable due to kj::String, kj::Vector
};
...
public:
  ...
  // Non-copyable, movable (but not move-assignable)
  ...
  ApiKeyManager& operator=(ApiKeyManager&&) = delete; // Not move-assignable due to kj::MutexGuarded
