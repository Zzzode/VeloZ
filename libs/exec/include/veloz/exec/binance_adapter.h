...
public:
    ...
    std::optional<std::map<double, double>> get_order_book(const veloz::common::SymbolId& symbol, int depth = 10);
    std::optional<std::vector<std::pair<double, double>>> get_recent_trades(const veloz::common::SymbolId& symbol, int limit = 500);
