...
public:
    ...
    void subscribe(const veloz::common::SymbolId& symbol,
                   MarketEventType event_type,
                   const std::string& subscriber_id);

    // Unsubscribe a client from a symbol/event type
    void unsubscribe(const veloz::common::SymbolId& symbol,
                     MarketEventType event_type,
                     const std::string& subscriber_id);
    ...
    [[nodiscard]] std::vector<MarketEventType> event_types(const veloz::common::SymbolId& symbol) const;
