...
std::string make_subscription_key(const veloz::common::SymbolId& symbol, MarketEventType event_type) {
...
std::vector<MarketEventType> SubscriptionManager::event_types(const veloz::common::SymbolId& symbol) const {
