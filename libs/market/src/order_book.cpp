...
void OrderBook::apply_snapshot(const std::vector<BookLevel>& bids,
                               const std::vector<BookLevel>& asks, std::int64_t sequence) {
  bids_.clear();
  asks_.clear();
...
std::vector<std::pair<double, double>> OrderBook::liquidity_profile(bool is_bid, double price_range,
                                                                    double step) const {
