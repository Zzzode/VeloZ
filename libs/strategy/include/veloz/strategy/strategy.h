...
namespace veloz::strategy {
     ...
     *
     * Defines the strategy types supported by the framework, including common quantitative trading strategy types.
     */
     ...
     *
     * Strategy factory is used to create strategy instances, implementing strategy decoupling and dynamic creation.
     */
     ...
     *
     * Strategy manager is responsible for strategy registration, creation, starting, stopping, and event dispatching.
     */
     ...
     * management functionality such as strategy ID generation, state management, initialization, and stopping.
     */
     ...
     *
     * Template class that implements the strategy factory interface, used to create specific types of strategy instances.
