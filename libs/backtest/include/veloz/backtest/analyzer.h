...
public:
    ...
    std::vector<EquityCurvePoint> calculate_equity_curve(const std::vector<TradeRecord>& trades, double initial_balance) override;
    std::vector<DrawdownPoint> calculate_drawdown(const std::vector<EquityCurvePoint>& equity_curve) override;
